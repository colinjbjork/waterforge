// Onsen recipe CLI.
//
//   npm run onsen -- <analysis.json> [--json]
//   cat analysis.json | npm run onsen -- [--json]
//
...
// over the full salt palette, and prints Markdown (default) or JSON (--json).
...
const USAGE = `usage: onsen [<analysis.json> | -] [--json]
  Reads the onsen analysis JSON from the given file (or stdin when omitted or
  "-") and prints a home-bath recipe as Markdown, or as JSON with --json.
